      ...
      <div className="flex w-full max-w-4xl flex-col overflow-hidden rounded-lg bg-white shadow-xl md:flex-row">
        ...
        <div className="flex flex-col justify-between bg-gradient-to-br from-purple-700 to-indigo-800 p-12 text-white md:w-1/2">
          <div>
            ...
            <h2 className="mt-12 text-3xl font-bold">Join Lumicoria</h2>
        ...
        <div className="md:w-1/2 p-12">
          <div className="mx-auto max-w-sm">
            <h3 className="mb-6 text-2xl font-bold text-gray-900">Create an account</h3>
                ...
                <div className="text-xs text-gray-500">
                  ...
                  <ul className="mt-1 list-inside list-disc">
                    {passwordRequirements.map((req, index) => (
                      <li
                        key={index}
                        className={req.regex.test(formData.password) ? 'text-green-600' : 'text-red-500'}
                      >
                        {req.text}
                      </li>
                    ))}
